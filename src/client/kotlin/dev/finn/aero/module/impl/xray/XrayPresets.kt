...
object XrayPresets {
    ...
    val BASE_FINDER: Set<Block> = setOf(
        ...
        // 1.21.11 still has one Blocks.* constant per colour rather than 26.x's
        // ColorCollection grouping -- listed explicitly.
        Blocks.SHULKER_BOX,
        ...
        // Beds -- same per-colour listing as shulker boxes above.
