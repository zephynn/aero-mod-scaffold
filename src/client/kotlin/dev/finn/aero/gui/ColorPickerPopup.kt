...
class ColorPickerPopup {
    ...
    private fun renderSvSquare(context: DrawContext) {
        val sx = svX()
        val sy = svY()
    ...
    private fun renderHueSlider(context: DrawContext) {
        val hx = hueX()
        val hy = hueY()
        val steps = 30
        val cell = SV_SIZE / steps
    ...
    private fun drawRing(context: DrawContext, cx: Int, cy: Int, r: Int, color: Int) {
    ...
    private fun drawBorder(context: DrawContext, bx: Int, by: Int, w: Int, h: Int, color: Int) {
